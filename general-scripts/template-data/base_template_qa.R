...
sheet1 <- box_read_excel(raw_box_id, sheet = 2)[2,-1]


## Sheet 2. Data description ####

sheet2 <- box_read_excel(raw_box_id, sheet = 3)[-1,-1]

## Sheet 3. Additional data availability ####

sheet3 <- box_read_excel(raw_box_id, sheet = 4)[-1,-1]

## Sheet 4. Treatments ####

sheet4 <-  box_read_excel(raw_box_id, sheet = 5)[-1, 2:4]

## Sheet 5. Plots ####

sheet5 <-  box_read_excel(raw_box_id, sheet = 6)[-1, -1]

## Sheet 6. Plants ####

sheet6 <- box_read_excel(raw_box_id, sheet = 7)[-1, -1]
