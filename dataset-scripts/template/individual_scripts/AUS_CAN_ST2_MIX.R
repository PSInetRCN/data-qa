...
dataset_identifier <- "AUS_CAN_ST2_MIX"
...
sheet1 <- sheet1 |> 
  mutate(data_publication = "Yes - as part of a scientific paper")
...
outcomes_report$remarks[which(outcomes_report$check == "sheet10_ranges")] <- "Slightly high PPFD, slightly low RH."
