...
sheet6 <- sheet6 |>
  mutate(plot_treatment_id = plot_id,
...
flag_summary <- "Data variable promised not provided; plants in WP not in plants; positive WP changed to negative"
