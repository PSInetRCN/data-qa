...
sheet1 <- sheet1 |>
  mutate(latitude_wgs84 = substr(latitude_wgs84, 1,8),
         longitude_wgs84 = substr(longitude_wgs84, 1, 8))
...
flag_summary <- "Incident rad marked as available but not provided"
