...
sheet1 <- sheet1 |>
 mutate(latitude_wgs84 = gsub("N", "", latitude_wgs84),
        longitude_wgs84 = gsub("W", "", longitude_wgs84),
        longitude_wgs84 = paste0("-1", longitude_wgs84),
        longitude_wgs84 = gsub("111", "11", longitude_wgs84)) # I looked up the paper and there is a typo :) 
...
sheet4_2 <- sheet4 |>
  mutate(treatment_id = "No treatment",
         treatment_description = NA)

sheet4 <- bind_rows(sheet4, sheet4_2)
